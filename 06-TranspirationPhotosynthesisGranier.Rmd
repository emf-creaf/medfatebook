# Plant cohort transpiration, photosynthesis and drought stress {#transpirationgranier}
...
### Transpiration of hemi-parasitic plants {#mistletoetranspiration}
...
Maximum transpiration is then reduced to actual transpiration (i.e. $Tr_{mistletoe, i}$) according to the water potential of the plant cohort ($\Psi_{plant,i}$), following a sigmoid function with parameters $Gs_{P50, mistletoe}$ and $Gs_{slope, mistletoe}$ (defined in control parameters). Soil water extraction corresponding to mistletoe transpiration is added to extraction caused by the corresponding plant cohort. 
