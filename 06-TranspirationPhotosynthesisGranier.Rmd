...
Maximum transpiration is then reduced to actual transpiration (i.e. $Tr_{mistletoe, i}$) according to the water potential of the plant cohort ($\Psi_{plant,i}$), following a sigmoid function with parameters  $\Psi50_{gs, mistletoe}$  and $slope_{gs, mistletoe}$ (defined in control parameters). Soil water extraction corresponding to mistletoe transpiration is added to extraction caused by the corresponding plant cohort. 
