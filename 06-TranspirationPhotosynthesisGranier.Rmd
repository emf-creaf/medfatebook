...
For simulations of several year, it is normally advisable to allow some recovery. If `cavitation = "annual"`, $PLC_{i}$ values are set to zero at the beginning of each year, assuming that embolized plants overcome the conductance loss by creating new xylem tissue.
