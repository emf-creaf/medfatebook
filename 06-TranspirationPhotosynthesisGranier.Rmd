...
Similarly to @Mouillot2002, daily drought stress of a given plant cohort $i$, $DDS_i$, is defined as the one-complement of relative whole-plant transpiration estimated from the plant water potential ($\Psi_{plant}$):
\begin{equation}
DDS_i=\phi_i \cdot (1-K(\Psi_{plant}))
\end{equation}
