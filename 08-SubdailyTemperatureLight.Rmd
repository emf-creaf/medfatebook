...
Once the air temperature for a given time step is known, instantaneous long-wave radiation (LWR) coming from the atmosphere ($L_{atm}$, in $W \cdot m^{-2}$) can be calculated following @Campbell1998:
\begin{equation}
...
\end{eqnarray}
where $vp_{atm}$ is the average daily water vapor pressure (in kPa; see \@ref(meteoinput)) and $c$ is the proportion of clouds ($c=1$ in rainy days and $c=0$ otherwise). 