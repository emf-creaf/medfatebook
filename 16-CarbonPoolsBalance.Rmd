...
M_{twig} &=& B_{living,twig} \cdot MR_{sapwood} \cdot Q_{10}^{(T_{mean}-20)/10} \\
M_{sapwood} &=& (B_{living,sapwood} + B_{sugar,sapwood}) \cdot MR_{sapwood} \cdot Q_{10}^{(T_{mean}-20)/10} \\
M_{fineroot} &=& B_{fineroot} \cdot MR_{fineroot} \cdot Q_{10}^{(T_{mean}-20)/10} \cdot ( LA_{\phi}/LA_{live}) 
\end{eqnarray}
