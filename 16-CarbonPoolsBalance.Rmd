...
Total living biomass per individual (i.e. not accounting for heartwood) is:
\begin{equation}
B_{total} = B_{leaf} + B_{sapwood} + B_{fineroot} + B_{sugar,leaf} + B_{starch,leaf}+ B_{sugar,sapwood} + B_{starch,sapwood}
\end{equation}
