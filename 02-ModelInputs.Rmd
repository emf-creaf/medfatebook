...
A plant cohort $i$ is either a *tree cohort* or a *shrub cohort*, and is defined using a set of structural attributes shown in the following table, where columns **spwb** and **growth** indicate whether attributes are required by functions `spwb()` (or `pwb()`) and `growth()`, respectively:
