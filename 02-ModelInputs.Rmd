...
g1<-vprofile_leafAreaDensity(exampleforest, SpParamsMED, z = seq(0,1000, by=1), byCohorts = T, includeHerbs = TRUE)
g1 <- g1 + theme(legend.background = element_blank(), legend.position = c(0.8,0.8))
g2<-vprofile_leafAreaDensity(exampleforest, SpParamsMED, z = seq(0,1000, by=1), includeHerbs = TRUE)
plot_grid(g1, g2, nrow=1, ncol=2)
```
