...
With the aim to help users in the task of constructing `forest` objects, the package also includes functions initialize empty forests and to map user data in into tables `treeData` and `shrubData` (see function `forest_mapWoodyTables()`).
