...
+ S3 class `soil` is a list that is initialized using soil physical properties, but the object includes also soil parameters and state variables. Soil objects are described in subsection \@ref(soilinitialization).
