...
Finally, we can also estimate the overall leaf area index of the whole stand ($LAI_{all,stand}$), which also takes into account the collective herbaceous layer ($LAI_{herb}$), if defined:

\begin{eqnarray}
LAI_{all, stand} &=& LAI_{all} + LAI_{herb} = LAI_{\phi}+LAI_{dead} + LAI_{herb} 
\end{eqnarray}
