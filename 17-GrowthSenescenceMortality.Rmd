...
\end{equation}
First, $\Delta LA_{alloc}$ is the maximum leaf area increment allowed by the leaf area target set by the allocation rule, $LA_{target}$, in comparison with current leaf area $LA_{\phi}$:
\begin{equation}
