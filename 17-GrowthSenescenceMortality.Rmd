...
\end{equation}
This allows a progressive increase in functional sapwood area. Similarly, if previous drought or fire impacts had reduced the percentage of the crown with active buds, it can increase with the formation of new sapwood area (until it achieves 100\%):
\begin{equation}
