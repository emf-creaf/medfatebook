...
| Element | Description                                                |
|---------|------------------------------------------------------------|
| `WaterBalance`| Climatic input and water balance flows (i.e. net precipitation, infiltration, runoff, transpiration...).|
| `Soil`| Soil variables  (volume, moisture relative to field capacity, water potential) for each soil layer. |
| `Stand`| Stand-level variables, such as $LAI$, the water retention capacity of the canopy or the fraction of light reaching the ground.|
