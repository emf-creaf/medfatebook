...
A third set of parameters are related to transpiration and photosynthesis (`paramsTranspiration`):
...
A forth (final) set of parameters are related to water storage and water relations in plant tissues (`paramsWaterStorage`):
