...
+ `cavitationRecoveryStem/cavitationRecoveryLeaves [= "annual"]`: A string indicating how refilling of embolized conduits is done  (see section \@ref(irreversiblecavitation). Allowed values are: 
  + `"none"` - no refilling.
