...
There is a small set of functional parameters in the basic water balance model. They should be supplied for each plant cohort $i$ and relate to light extinction, water interception, transpiration and leaf phenology processes (`paramsBase`):
