...
In turn, when missing tissue nitrogen concentrations are estimated from taxonomic family using an internal data set (`medfate:::trait_family_means`):
```{r echo = FALSE}
tfm = medfate:::trait_family_means
...
When family values are missing, default nitrogen concentrations are given: $N_{leaf} = 20.088$, $N_{sapwood} = 3.9791$ and $N_{fineroot} = 12.207$.
