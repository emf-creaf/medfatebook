...
for(i in 1:length(pres)) {
  ...
  krhizomaxvec1[3]= hydraulics_findRhizosphereMaximumConductance(pres[i], 
                     ...
                     kstemmax, stemc, stemd,
                     kleafmax, leafc, leafd)
  hn1 <- list("psisoil" = psiSoilLayers1,
             ...
             "PLCstem" =plcCav)
  sfn1 = hydraulics_supplyFunctionNetwork(hn1, maxNsteps = 400)
  hn2 <- hn1
  hn2$psisoil <- psiSoilLayers2
  sfn2 = hydraulics_supplyFunctionNetwork(hn2, maxNsteps = 400)
  hn3 <- hn1
  hn3$psisoil <- psiSoilLayers3
  sfn3 = hydraulics_supplyFunctionNetwork(hn3, maxNsteps = 400)
  hn4 <- hn1
  hn4$psisoil <- psiSoilLayers4
  sfn4 = hydraulics_supplyFunctionNetwork(hn4, maxNsteps = 400)
  if(i==1) {
