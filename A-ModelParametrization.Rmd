...
```{r echo = FALSE}
knitr::kable(taxonomic_partitioning |> dplyr::filter(Trait %in% c("Gswmin", "Gswmax")),
                ,
             caption = 'Number of species with available data and percentage of variance explained individually by family and genus, and total explained variance for taxonomically-based imputations of minimum and maximum conductance to water vapour.')
```
