...
| $1/H_{v}$  |  `Al2As` | Ratio of leaf area to sapwood area | No | No | \@ref(imputationHv) | 
|  $LW$   | `LeafWidth` | Leaf width | Yes | No | No |
| $SLA$  |  `SLA` | Specific leaf area | Yes | No | No |
...
### Huber value {#imputationHv}

When missing from species parameter table, the ratio of leaf area to sapwood area (i.e. the inverse of Huber value) is set to a default value $1/Hv = 2500$ (i.e. $Hv = 4 \,cm·m^{-2}$). [JUSTIFICATION MISSING]
