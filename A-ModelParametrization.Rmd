...
| $WUE_{\max}$ | `WUE` |  Maximum water use efficiency under full light and without water or CO2 limitations  | No | No | \@ref(imputationtranspwue) |
| $WUE_{PAR}$ | `WUE_par` |  Coefficient describing the decay of water use efficiency with low light levels  | No | No | \@ref(imputationtranspwue) |
| $WUE_{CO2}$ | `WUE_co2` |  Coefficient for gross photosynthesis dependency on atmospheric CO2 concentration  | No | No | \@ref(imputationtranspwue) |
