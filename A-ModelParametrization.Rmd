...
When maximum water use efficiency ($WUE_{\max}$) is missing, it is given a value of $WUE_{\max} = 5$. By default, the coefficient describing the decay of water use efficiency with lower light levels is given a default value of $WUE_{decay} = 0.2812$.
