# (PART) Landscape modelling {-}

# Watershed hydrology {#watershedhydrology}

This chapter describes the distributed watershed water balance model implemented in functions `spwb_land()` and `growth_land()` of package **medfateland**. 
