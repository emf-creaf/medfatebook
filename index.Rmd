...
You should look at **medfate** and **medfateland** R packages as an ongoing research project for the development of forest ecosystem modelling tools. The models included in the package may contain bugs, and provide wrong predictions (all models are *wrong*, remember?). Package functions may evolve in the future, so that you may have to modify your scripts after package updates (hopefully not too often). Nevertheless, we feel the tool is mature enough to become useful for applications and that is why we made an effort to document it thoroughly. The R packages are the result of collaborative work between modelers and experts in different disciplines. If your own expertise includes any of the processes that are modeled in the package and you feel that your expertise could be helpful to improve the package, you are more than welcome to contact us!
