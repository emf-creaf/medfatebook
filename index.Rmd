...
This *reference book* is meant to help you understand the static and dynamic models included in packages **medfate** (ver. **`r packageVersion("medfate")`**) and **medfateland** (ver. **`r packageVersion("medfateland")`**). Hands-on user guides to run simulation functions and static functions can be found in *articles* of the [package website](https://emf-creaf.github.io/medfate/) and training course materials can be found [here](https://emf.creaf.cat/training/medfate_course/). As any reference book, you are not expected to read the book linearly, but to jump to specific book sections whenever you have doubts about the design or implementation of certain processes or calculations. 
