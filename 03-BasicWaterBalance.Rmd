...
+  `mistletoeParams`: A list with the following elements:
    ...
    + `Gs_P50 [= -4.0]`: Water potential corresponding to 50% reduction of mistletoe stomatal conductance (i.e. $\Psi50_{gs, mistletoe}$).
    + `Gs_slope [= 30]`: Rate of decrease in mistletoe stomatal conductance at Gs_P50 (i.e. $slope_{gs, mistletoe}$).
