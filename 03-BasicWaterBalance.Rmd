...
\begin{equation}
\Delta{V_{soil}} = (If + Lw + Cr) - (Dd + Se + Es + Tr_{herb} + Tr_{cohorts})
...
For every day to be simulated, the model performs the following steps:
  ...
  4. Determine plant cohort transpiration ($Tr_{cohorts}$), including hydraulic redistribution, and photosynthesis (chapter \@ref(transpirationgranier)). Update plant water potential ($\Psi_{plant}$) and plant drought stress for each plant cohort.
