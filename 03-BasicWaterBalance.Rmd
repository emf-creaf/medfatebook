...
Optionally, the model can simulate additional transpiration caused by hemi-parasitic plants (mistletoe) attached to specific plant cohorts. This causes water update from the corresponding soil water pools to be higher than cohort transpiration.
