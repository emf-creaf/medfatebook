...
+ `truncateRootDistribution [=TRUE]`: Boolean flag to indicate that fine root distribution is to be truncated (i.e. $Z_{100}$ is estimated from $Z_{95}$ when not provided).
