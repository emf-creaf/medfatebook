...
Water balance is performed for both the snow pack and the soil (see fig. \@ref(fig:waterbalance)). Precipitation ($P$) is considered be snow precipitation ($Ps$) or rainfall ($Pr$), depending on temperature. Thus, we have:
\begin{equation}
P = Pr + Ps
\end{equation}
...
```{r waterbalance, out.width='100%', fig.align="center", fig.cap="Schematic representation of soil and snow pack water balance components. Lateral source/sinks and runon are omitted for simplicity.", echo=FALSE}
