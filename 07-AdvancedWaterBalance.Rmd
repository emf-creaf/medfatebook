...
+ `klat [= 0.1]`: Stem symplastic-apoplastic lateral conductance (in $mmol·s^{-1}·m^{-2}·MPa^{-1}$). Only relevant when `capacitance = TRUE` (see section \@ref(hydraulicswithcompartments)).
+ `ksymver [= 0.05]`: Leaf-stem symplastic vertical conductance (in $mmol·s^{-1}·m^{-2}·MPa^{-1}$). Only relevant when `capacitance = TRUE` (see section \@ref(hydraulicswithcompartments)).
