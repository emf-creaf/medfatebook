...
For example, Vilà-Vilardell et al. @vila-vilardell_prescribed_2023 employed the advanced water balance model to assess the effect of thinning and prescribed burning on drought stress of Pinus nigra stands. Similarly, Saponaro et al. @saponaro_assessing_2024 employed advanced modeling to assess the combined effect of climatic changes and forest management on carbon and water fluxes in beech forests. Finally, Cabon et al. @cabon_probing_2024 used advanced model simulations to obtain estimates of photosynthesis and leaf water potential, and evaluate the relative importance of source and sink limitations to tree growth.
