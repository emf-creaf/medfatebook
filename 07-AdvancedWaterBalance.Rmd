...
+ `plantWaterPools [=FALSE]`: Boolean flag to indicate the simulation of water balance assuming that each cohort has its own water pools (correlation between pools of different cohorts is regulated via `poolOverlapFactor`).
+ `poolOverlapFactor [= 0.5]`: Factor regulating the relationship between stand LAI and root overlap (actual overlap also depends on the proportion of fine roots, see section \@ref(plantwaterpools)).
