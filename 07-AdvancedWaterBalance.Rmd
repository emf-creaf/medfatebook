...
+ `cavitationRefill [= "annual"]`: A string indicating how refilling of embolized conduits is done  (see section \@ref(cavitationrefill). Allowed values are: 
  + `"none"` - no refilling.
...
+ `capacitance [= TRUE]`: Whether the effect of (symplasmic or apoplasmic) plant water compartments is considered in simulations.
...
+ `Q10_1_gmin [= 1.2]`: Temperature dependance of gmin when T ≤ TPhase.
+ `Q10_2_gmin [= 4.8]`: Temperature dependance of gmin when T > TPhase.
