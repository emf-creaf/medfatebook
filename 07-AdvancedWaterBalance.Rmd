...
+ `poolOverlapFactor [= 0.5]`: Factor regulating the relationship between stand LAI and root overlap (actual overlap also depends on the proportion of fine roots).
