...
Control parameters modulate the overall behaviour of water balance simulations (see section \@ref(controlparameters)). The control values relevant for the advanced water balance model are:
