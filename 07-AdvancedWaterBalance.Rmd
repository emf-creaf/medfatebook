...
+ `leafCavitationRecovery / stemCavitationRecovery [= "rate"]`: A string indicating how to model recovery of xylem conductance  (see section \@ref(cavitationRecovery)). Allowed values are: 
  + `"none"` - no recovery.
