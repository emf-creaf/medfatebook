...
7. Determine instantaneous plant cohort transpiration, photosynthesis rates and close soil/canopy energy balance at sub-daily steps (chapters \@ref(transpirationsperrysureau) and \@ref(closecanopysoilenergybalance)). This involves the following actions for each sub-daily step:
    ...
    c. If `transpirationMode = "Sureau"`, for each plant cohort repeat the following in small temporal sub-steps (e.g. 10 min):

       i. Perform energy balance of sunlit and shade leaves (section \@ref(leafenergybalancephoto)), according to the current transpiration flux.
       ii. Calculate shade-leaf, sunlit-leaf and stem cuticular conductances and cuticular transpiration (\@ref(cuticularconductancesureau)).
       iii. Determine stomatal regulation and stomatal transpiration for sunlit and shade leaves (\@ref(stomatalconductancesureau)).
       iv. Determine photosynthesis for sunlit and shade leaves (assuming gas exchange occurs through stomatal and cuticular pathways).
       v. Update water potentials, water fluxes (including soil extraction) and hydraulic conductances across the plant hydraulic network.
