...
\end{equation}
where $k_{PAR,i}$ is the PAR extinction coefficient of cohort $i$. We can also define $L^{PAR}_i$ as the proportion of PAR available for a given plant cohort $i$, which we associate to the PAR available at a height corresponding to half of the cohort's crown. This height will include some self-shading of the target cohort.
