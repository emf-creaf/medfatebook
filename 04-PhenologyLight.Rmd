...
g1<-vprofile_PARExtinction(exampleforestMED, SpParamsMED, z = seq(0,1000, by=1), includeHerbs = TRUE)
g2<-vprofile_SWRExtinction(exampleforestMED, SpParamsMED, z = seq(0,1000, by=1), includeHerbs = TRUE)
