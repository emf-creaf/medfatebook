...
```{r phenology, out.width='80%', fig.align="center", fig.cap="Schematic representation of processes and timings for different leaf phenology types", echo=FALSE}
