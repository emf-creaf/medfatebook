...
While acknowledging that the phenology of specific plants may not fit exactly into them, in MEDFATE the following four phenological types are distinguished (see processes and timings in Fig. \@ref(fig:phenology)):

  + *Progressive evergreen*: Progressive evergreen plants are assumed to shed old leaves at the same time as new leaves appear. In the water balance models, this phenological behaviour means that the leaf area of the cohort remains constant throughout the year. In the case of the growth model, leaf senescence and leaf formation can occur continuously throughout the year, and leaf growth occurs without preformation of organs within buds.
  + *One-flush evergreen*: One-flush evergreen plants are assumed concentrate leaf unfolding and leaf senescence during similar periods. More specifically, leaf senescence occurs at the same time as the start of unfolding of new leaves, so that leaf area is partially reduced for a small period. In the growth model, the amount of leaf area to be flushed is decided during the bud formation period, when leaf organogenesis is assumed to occur. This is assumed to occur between DOY 200 and the start of dormancy. Hence, limitations to the formation of new leaves can occur during bud formation or leaf unfolding periods.
  + *Winter-deciduous*: In winter-deciduous plants, leaf shedding and leaf bud formation both occur in autumn, and buds remain under dormancy until spring, when budburst and unfolding occurs. Therefore, the plant has a non-zero leaf area during the period limited by leaf unfolding and leaf shedding events. Like in one-flush evergreen plants, the amount of leaf area to be flushed is decided during the bud formation period for the growth model, which in this case is set to occur between the decrease of photoperiod and the start of dormancy.
  + *Winter semi-deciduous*: Winter semideciduous plants are like deciduous ones in terms of senescence, bud formation and leaf unfolding. The only difference between semi-deciduous and deciduous plants is that the former retain dead leaves in the plant until next season unfolding period, so that leaf fall is retarded (note that leaf fall is not represented in Fig. \@ref(fig:phenology)). 
...
Evergreen plants thus maintain constant leaf area over the year, whereas in deciduous plants leaf-expanded status is updated daily, represented by $\phi_i$, the fraction of maximum leaf area for cohort $i$:
