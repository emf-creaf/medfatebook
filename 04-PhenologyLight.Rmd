...
### Leaf phenology and phenological models

The following three phenological types are currently distinguished (see also primary growth phenology in \@ref(growthdesign)):

  + *Evergreen*: Evergreen plant cohort keep the same amount of leaves constant throughout the year (unless there is cavitation-induced defoliation).  
  + *Winter-deciduous*: In winter-deciduous plants, leaf shedding and leaf bud formation both occur in autumn, and buds remain under dormancy until spring, when budburst and elongation occurs. Therefore, the plant has a non-zero leaf area during the period limited by leaf elongation and leaf shedding events.  
...
Evergreen plants thus maintain constant leaf area over the year, whereas in other leaf phenology types leaf-expanded status is updated daily, represented by $\phi_i$, the fraction of maximum leaf area for cohort $i$:
