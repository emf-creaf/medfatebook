...
Water from rainfall events is divided between runoff and infiltration. In consrast, snow melt ($Sm$) does not participate from infiltration/runoff partitioning, because melting rates are assumed to be slow enough to infiltrate completely (see \@ref(richards)).

### Runon, runoff and infiltration

The amount of rainfall event water that reaches the soil is the sum of net rainfall ($Pr_{net}$) and runon ($Ro$, in mm), if any. The amount of rainfall event water infiltrating into the soil is $If = Pr_{net} + Ro - Ru$, where $Ru$ (in mm) is the rainfall water lost by surface runoff (see function `hydrology_infiltrationAmount()`). 
