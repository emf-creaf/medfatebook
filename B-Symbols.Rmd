...
| $l$ | (count) | | Number of vertical layers for leaf distribution |
...
| $H_{ca}$ | $W \cdot m^{-2}$ | `Hcan` |  Sensible heat exchange between the canopy and the atmosphere |
| $H_{j}$ | $W \cdot m^{-2}$ | | Sensible heat flux in canopy layer $j$ |
| $H_{cs}$ | $W \cdot m^{-2}$ | `Hcansoil` |  Sensible heat exchange between the canopy and the soil |
...
| $T_{atm}$ | $^\circ \mathrm{C}$ | `Tatm` | Above-canopy air temperature |
| $T_{air,can}$ | $^\circ \mathrm{C}$ | `Tcan` | Canopy air temperature |
| $T_{air,j}$ | $^\circ \mathrm{C}$ |  | Air temperature in canopy layer $j$ |
