...
| Symbol | Units | R | Description                        |
|--------|-------|---------|------------------------------------|
| $WUE_{\max}$ | $g\, C \cdot mm^{-1}$ |  `WUE` |  Maximum water use efficiency under full light and no water limitations  |
| $WUE_{decay}$ |  |  `WUE_decay` |  Exponent describing the decay of water use efficiency with low light levels  |
