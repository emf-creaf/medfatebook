...
| Symbol | Units | R | Description                        |
|--------|-------|---------|------------------------------------|
| $WUE_{\max}$ | $g\, C \cdot mm^{-1}$ |  `WUE` |  Maximum water use efficiency under full light and without water or CO2 limitations  |
| $WUE_{PAR}$ |  |  `WUE_par` |  Coefficient describing the decay of water use efficiency with low light levels  |
| $WUE_{CO2}$ |  |  `WUE_co2` |  Coefficient for gross photosynthesis dependency on atmospheric CO2 concentration  |
