...
| $C_{canopy}$ | $J \cdot m^{-2} \cdot K^{-1}$ | | Canopy thermal capacitance |
| $C_{LAI}$ | $J \cdot m^{-2} \cdot K^{-1}$ | `thermalcapacityLAI` | Canopy thermal capacitance per LAI unit |
| $C_{soil,s}$ | $J \cdot m^{-2} \cdot K^{-1}$ | | Thermal capacitance of soil layer $s$ |
