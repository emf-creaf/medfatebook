...
Resprouting is a common feature of Mediterranean species. Here resprouting is assumed happen from buds at the stump/stool level after a given disturbance has led to aboveground plant die-back. Resprouting can occur as a response to different disturbances. For example, resprouting occurs after clipping (e.g. if management is applied), after a fire, or after cavitation has led to dessication of above-ground plant organs. The density of resprouts depends on the cause underlying the resprouting, but in all cases the resprouts inherit the root system of their parent. Like saplings, resprouts are subject to self-thinning processes before attaining the diameter of adults.
