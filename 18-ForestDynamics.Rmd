...
\begin{equation}
N_{resp} = N_{surv} \cdot SA \cdot 1.82 \cdot 10^{-0.053\cdot x}
\end{equation}

where $x = 5$ is time in years, $N_{resp}$ is the number of resprouts, $N_{surv}$ is the number of parent trees that survived. 
