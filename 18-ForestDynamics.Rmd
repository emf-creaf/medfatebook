...
| $DBH_{recr}$  | $cm$  | `RecrTreeDBH` | DBH for tree recruits from seeds (e.g. 1 cm). |
| $DBH_{ingrowth}$  | $cm$  | `IngrowthTreeDBH` | Ingrowth DBH for trees (e.g. 7.5 cm). |
| $H_{tree, recr}$  | $cm$  | `RecrTreeHeight` | Height for tree recruits from seeds |
