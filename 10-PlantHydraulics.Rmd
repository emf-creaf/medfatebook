...
Stem cuticular transpiration ($E_{cuti,stem}$), leaf cuticular transpiration ($E_{cuti, leaf}$) and leaf stomatal transpiration ($E_{stom}$) are described in section \@ref(transpirationcochard).
