...
The way the previous architecture is implemented is the following. Two supply functions are needed, one from soil nodes to $\Psi_{stem,1}$, and the other from $\Psi_{rootsurf}$ to $\Psi_{leaf}$. 
