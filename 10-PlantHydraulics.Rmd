...
\end{equation}
where $V_{stem,apo,max}$ is the capacity of the stem xylem compartment. Otherwise, $\delta{V_{cav}}/\delta t=0.0$. The change in water pressure in the stem xylem compartment following the change in water volume follows:
\begin{equation}
