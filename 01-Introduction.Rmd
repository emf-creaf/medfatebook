...
knitr::include_graphics("Package_design_medfate.png")
...
```{r designmedfateland, out.width='100%', fig.align="center", fig.cap="Overview of simulation functions in medfateland and the processes available for each of them", echo=FALSE}
