...
The package offers a simulation function where the dynamics of forest stands are related by management and/or fire regime scenarios:

+ Function `fordyn_scenario()` allows simulating `fordyn()` on forest stands, while applying a demand-based forest management scenario and/or a fire regime scenario.

Finally, there are three functions that are meant to simulate watersheds, including landscape spatial processes:
...
+ Forest dynamics arising from competition for light and water can be simulated in a watershed using function `fordyn_land()`.
