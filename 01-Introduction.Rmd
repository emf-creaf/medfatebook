...
While all simulation functions in the package focus on particular forest stands and vertical hydrological processes, the package has been designed so that it could be part of a broader modelling infrastructure including *spatial processes* such as lateral water flows.
