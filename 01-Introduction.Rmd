...
Package **medfateland** allows simulating forest functioning and dynamics on sets forests stands distributed spatially. Three S4 classes have been defined to facilitate simulations on particular locations and over grids. They extend spatial classes from package **meteoland**
...
Package **medfateland** offers sets of simulation functions for the three S4 classes presented above. Simulations available are analogous to those of package **medfate**:
