...
Surplus in leaf or sapwood storage carbon is diverted towards root exudation ($RE_{leaf}$ or $RE_{sapwood}$). Hence, root exudation is not a process competing for metabolic carbon, but only a consequence of plant C storage capacity being surpassed [@Prescott2020]. Root exudation will happen in the model when growth is restricted due to sink limitations but photosynthesis continues and storage carbon levels have attained the storage capacity in the leaf or sapwood compartments.