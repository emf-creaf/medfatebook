...
\begin{equation}
LE_{soil} = \lambda_v(T_{soil}) \cdot \left( \frac{Es_{t} + \lambda_{f} \cdot Sm_{t}}{\Delta t_{step}} \right)
(\#eq:soillatentheat)
\end{equation}
