...
\begin{equation}
LE_{c} = \lambda_v(T_{canopy}) \left(In_{step} + \sum_{i}{E_i} \right)
\end{equation}
...
\begin{equation}
LE_s = \lambda_v(T_{soil}) \cdot Es_{step} + \lambda_{f} \cdot Sm_{step}
\end{equation}
...
## Canopy capacitance and temperature changes {#canopycapacitancetemperature}
...
\begin{equation}
\Delta T_{soil,s} = \Delta t_{step} \cdot \frac{\delta T_{soil,s}}{\delta t}
\end{equation}