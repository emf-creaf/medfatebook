...
par(mar=c(4,4,2,1), mfrow=c(2,2))
plot(psi2A11$Gsw, PM11$Profit, type="l", col=col1, ylab="Profit (a = 1)", xlab = "Stomatal conductance",  xlim=c(0.001, 0.5), log="x", ylim=c(0,1), lwd=1, main="original")
...
plot(psi2A11emb$Gsw, PM11emb$Profit, type="l", col=col1, ylab="Profit (a = 1)", xlab = "Stomatal conductance",  xlim=c(0.001, 0.5), log="x", ylim=c(0,1), lwd=1, main="after cavitation")
...
plot(psi2A11$Gsw, PM11_s2$Profit, type="l", col=col1, ylab="Profit (a = 0.5)", xlab = "Stomatal conductance",  xlim=c(0.001, 0.5), log="x", ylim=c(0,1), lwd=1, main="original")
points(psi2A11$Gsw[PM11_s2$iMaxProfit+1],
         PM11_s2$Profit[PM11_s2$iMaxProfit+1], col=col1, pch = 0)
lines(psi2A12$Gsw, PM12_s2$Profit, lty=1, lwd=1, col=col2)
points(psi2A12$Gsw[PM12_s2$iMaxProfit+1],
         PM12_s2$Profit[PM12_s2$iMaxProfit+1], col=col2, pch = 0)
lines(psi2A13$Gsw, PM13_s2$Profit, lty=1, lwd=1, col=col3)
points(psi2A13$Gsw[PM13_s2$iMaxProfit+1],
         PM13_s2$Profit[PM13_s2$iMaxProfit+1], col=col3, pch = 0)
lines(psi2A14$Gsw, PM14_s2$Profit, lty=1, lwd=1, col=col4)
points(psi2A14$Gsw[PM14_s2$iMaxProfit+1],
         PM14_s2$Profit[PM14_s2$iMaxProfit+1], col=col4, pch = 0)
lines(psi2A21$Gsw, PM21_s2$Profit, lty=2, lwd=1, col=col1)
points(psi2A21$Gsw[PM21_s2$iMaxProfit+1],
         PM21_s2$Profit[PM21_s2$iMaxProfit+1], col=col1, pch = 0)
lines(psi2A22$Gsw, PM22_s2$Profit, lty=2, lwd=1, col=col2)
points(psi2A22$Gsw[PM22_s2$iMaxProfit+1],
         PM22_s2$Profit[PM22_s2$iMaxProfit+1], col=col2, pch = 0)
lines(psi2A23$Gsw, PM23_s2$Profit, lty=2, lwd=1, col=col3)
points(psi2A23$Gsw[PM23_s2$iMaxProfit+1],
         PM23_s2$Profit[PM23_s2$iMaxProfit+1], col=col3, pch = 0)
lines(psi2A24$Gsw, PM24_s2$Profit, lty=2, lwd=1, col=col4)
points(psi2A24$Gsw[PM24_s2$iMaxProfit+1],
         PM24_s2$Profit[PM24_s2$iMaxProfit+1], col=col4, pch = 0)
lines(psi2A31$Gsw, PM31_s2$Profit, lty=3, lwd=1, col=col1)
points(psi2A31$Gsw[PM31_s2$iMaxProfit+1],
         PM31_s2$Profit[PM31_s2$iMaxProfit+1], col=col1, pch = 0)
lines(psi2A32$Gsw, PM32_s2$Profit, lty=3, lwd=1, col=col2)
points(psi2A32$Gsw[PM32_s2$iMaxProfit+1],
         PM32_s2$Profit[PM32_s2$iMaxProfit+1], col=col2, pch = 0)
lines(psi2A33$Gsw, PM33_s2$Profit, lty=3, lwd=1, col=col3)
points(psi2A33$Gsw[PM33_s2$iMaxProfit+1],
         PM33_s2$Profit[PM33_s2$iMaxProfit+1], col=col3, pch = 0)
lines(psi2A34$Gsw, PM34_s2$Profit, lty=3, lwd=1, col=col4)
points(psi2A34$Gsw[PM34_s2$iMaxProfit+1],
         PM34_s2$Profit[PM34_s2$iMaxProfit+1], col=col4, pch = 0)
legend("topright", bty="n", legend=textures, lwd=1, lty=1:3, cex=0.8)
abline(h=0,col="gray")
abline(v=Gmin, col="gray", lwd=1.5)
...
plot(psi2A11emb$Gsw, PM11emb_s2$Profit, type="l", col=col1, ylab="Profit (a = 2)", xlab = "Stomatal conductance",  xlim=c(0.001, 0.5), log="x", ylim=c(0,1), lwd=1, main="after cavitation")
points(psi2A11emb$Gsw[PM11emb_s2$iMaxProfit+1],
         PM11emb_s2$Profit[PM11emb_s2$iMaxProfit+1], col=col1, pch = 0)
lines(psi2A12emb$Gsw, PM12emb_s2$Profit, lty=1, lwd=1, col=col2)
points(psi2A12emb$Gsw[PM12emb_s2$iMaxProfit+1],
         PM12emb_s2$Profit[PM12emb_s2$iMaxProfit+1], col=col2, pch = 0)
lines(psi2A13emb$Gsw, PM13emb_s2$Profit, lty=1, lwd=1, col=col3)
points(psi2A13emb$Gsw[PM13emb_s2$iMaxProfit+1],
         PM13emb_s2$Profit[PM13emb_s2$iMaxProfit+1], col=col3, pch = 0)
lines(psi2A14emb$Gsw, PM14emb_s2$Profit, lty=1, lwd=1, col=col4)
points(psi2A14emb$Gsw[PM14emb_s2$iMaxProfit+1],
         PM14emb_s2$Profit[PM14emb_s2$iMaxProfit+1], col=col4, pch = 0)
lines(psi2A21emb$Gsw, PM21emb_s2$Profit, lty=2, lwd=1, col=col1)
points(psi2A21emb$Gsw[PM21emb_s2$iMaxProfit+1],
         PM21emb_s2$Profit[PM21emb_s2$iMaxProfit+1], col=col1, pch = 0)
lines(psi2A22emb$Gsw, PM22emb_s2$Profit, lty=2, lwd=1, col=col2)
points(psi2A22emb$Gsw[PM22emb_s2$iMaxProfit+1],
         PM22emb_s2$Profit[PM22emb_s2$iMaxProfit+1], col=col2, pch = 0)
lines(psi2A23emb$Gsw, PM23emb_s2$Profit, lty=2, lwd=1, col=col3)
points(psi2A23emb$Gsw[PM23emb_s2$iMaxProfit+1],
         PM23emb_s2$Profit[PM23emb_s2$iMaxProfit+1], col=col3, pch = 0)
lines(psi2A24emb$Gsw, PM24emb_s2$Profit, lty=2, lwd=1, col=col4)
points(psi2A24emb$Gsw[PM24emb_s2$iMaxProfit+1],
         PM24emb_s2$Profit[PM24emb_s2$iMaxProfit+1], col=col4, pch = 0)
lines(psi2A31emb$Gsw, PM31emb_s2$Profit, lty=3, lwd=1, col=col1)
points(psi2A31emb$Gsw[PM31emb_s2$iMaxProfit+1],
         PM31emb_s2$Profit[PM31emb_s2$iMaxProfit+1], col=col1, pch = 0)
lines(psi2A32emb$Gsw, PM32emb_s2$Profit, lty=3, lwd=1, col=col2)
points(psi2A32emb$Gsw[PM32emb_s2$iMaxProfit+1],
         PM32emb_s2$Profit[PM32emb_s2$iMaxProfit+1], col=col2, pch = 0)
lines(psi2A33emb$Gsw, PM33emb_s2$Profit, lty=3, lwd=1, col=col3)
points(psi2A33emb$Gsw[PM33emb_s2$iMaxProfit+1],
         PM33emb_s2$Profit[PM33emb_s2$iMaxProfit+1], col=col3, pch = 0)
lines(psi2A34emb$Gsw, PM34emb_s2$Profit, lty=3, lwd=1, col=col4)
points(psi2A34emb$Gsw[PM34emb_s2$iMaxProfit+1],
         PM34emb_s2$Profit[PM34emb_s2$iMaxProfit+1], col=col4, pch = 0)
legend("topright", bty="n", legend=textures, lwd=1, lty=1:3, cex=0.8)
abline(h=0,col="gray")
abline(v=Gmin, col="gray", lwd=1.5)
