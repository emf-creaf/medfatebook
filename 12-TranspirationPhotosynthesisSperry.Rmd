...
\end{equation}
where $k_c(\Psi) = dE/d\Psi(\Psi)$ is the slope of the supply function corresponding to (leaf) water potential $\Psi$, $k_{c,max}$ is the maximum slope of the supplyh funciton, i.e. the maximum whole-plant conductance for the current soil moisture conditions, and $k_{crit} = k_c(\Psi_{crit})$ is the slope of the supply function at $E = E_{crit}$ the critical flow beyond which hydraulic failure occurs. 
...
The type of cost function can be specified by changing the control parameter `hydraulicCostFunction`. The following figures illustrate the $\theta_1$ and $\theta_2$ curves corresponding to the supply functions:

(ref:costfunction-cap) Cost functions 1 and 2 (i.e. $\theta_1$ and $\theta_2$) obtained for a hydraulic network, corresponding to fig. \@ref(fig:supplynetwork) and different soil textures and soil water potentials. Left/right panels show values for uncavitated/cavitated supply functions, respectively. 
...
(ref:gainfunction-cap) Gain function ($\beta$) obtained for a hydraulic network, corresponding to fig. \@ref(fig:supplynetwork) and different soil textures and soil water potentials. Left/right panels show values for uncavitated/cavitated supply functions, respectively. 
...
(ref:profitfunction-cap) Profit functions 1 and 2 (i.e. $Profit_1$ and $Profit_2$) obtained for a hydraulic network, corresponding to fig. \@ref(fig:supplynetwork) and different soil textures and soil water potentials. Left/right panels show values for uncavitated/cavitated supply functions, respectively. 
