...
\end{equation}
where the terms were defined in \@ref(soilwaterbalance). Here, the lateral flows (i.e. $Lw$) are specially important, compared to spatially-uncoupled simulations. They are defined as $Lw = \Delta S_{sat}$, the variation in water content derived from the balance between saturated soil lateral inputs and outputs:
\begin{equation}
Lw = \Delta S_{sat} = S_{sat, in} - S_{sat, out}
\end{equation}
