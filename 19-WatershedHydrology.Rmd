...
10. Apply drainage losses from the aquifer towards a deeper aquifer not connected to watershed outlets (\@ref(deepaquiferloss)), completing eq. \@ref(eq:cellaquiferwaterbalanceequation).
...
| $R_{lat}$        | `R_interflow` |  Multiplier of soil lateral conductivity (\@ref(eq:interflowtransmissivity)). |
| $R_{base}$       | `R_baseflow` |  Multiplier of groundwater lateral conductivity (\@ref(eq:baseflowtransmissivity)). |
| $n_{lat}$        | `n_interflow` |  Exponent of soil lateral conductivity (\@ref(eq:interflowtransmissivity)). |
| $n_{base}$       | `n_baseflow` |  Exponent of groundwater lateral conductivity (\@ref(eq:baseflowtransmissivity)). |
