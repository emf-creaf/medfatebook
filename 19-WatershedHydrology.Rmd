...
For every day to be simulated in a watershed or subwatershed, the model performs the following steps:
 ...
 3. Process cell vertical processes, including overland runoff-runon dynamics:
 ...
 4. Calculation of groundwater lateral flows between adjacent cells (see \@ref(subsurfaceflows)).
 5. Apply changes in cell aquifer water content due to the balance of groundwater lateral flows ($\Delta{S_{base}}$ in eq. \@ref(eq:cellaquiferwaterbalanceequation)) and vertical flows between soils and the aquifer below, i.e. deep drainage and capillarity rise.
 6. Apply drainage losses from the aquifer towards a deeper aquifer not connected to watershed outlets (\@ref(deepaquiferloss)), completing eq. \@ref(eq:cellaquiferwaterbalanceequation).
...
Both soil saturated and groundwater lateral fluxes follow the saturated subsurface flow model of Wigmosta et al. [-@Wigmosta1994], which is based on a kinematic wave approximation. Each grid cell can exchange water with its eight adjacent neighbors. 

#### Soil saturated lateral flow
...
The transmissivity function for groundwater lateral flux in cell $i$ ($T_{base,i}$) is analogous to the soil saturated lateral flows: 
\begin{equation}
