...
8. Distribute overland flows from cells having soil downhill (see \@ref(overlandflows)). If a cell is part of the channel network, its runoff is added to the backlog of the corresponding watershed outlet (see \@ref(watershedexport)). If a cell does not have downhill neighbors (i.e outlet cell) and is not in a channel, its runoff becomes water exported from the watershed (see \@ref(watershedexport)).
9. If a channel network is defined, advance one day the backlog of network outlets to apply channel routing (see \@ref(watershedexport)).
