...
### Tissue growth and senescence {#growthsenescencedesign}
...
The forest growth model allows simulating the variation of leaf area, sapwood area and fine root area via the following growth and senescence processes (see fig. \@ref(fig:allocationdiagram)):
 ...
 i. **Leaf/twig growth**:  Leaf area increase occurs during *leaf elongation* periods (after budburst) or during **indetermined (free) growth**. Leaf elongation of preformed leaves can be reduced due to turgor limitations during the expansion process, but does not take into account temperature effects. In indetermined free growth, the rate of new leaf formation is affected by both temperature and turgor conditions. Leaf area target limits the maximum amount of leaves formed during organogenesis and this target is determined by plant size (i.e. tree diameter) and stand structure (i.e. competition for light) via allometric equations. Organogenesis during persistent bud formation does not consume any carbon, but leaf elongation or indetermined (free) leaf growth does consume carbon and storage carbon levels need to be at more than 10\% of their capacity. Moreover, leaf growth includes an additional carbon cost in *twig growth*, according to the biomass ratio between both.
...
The growth rates in all three compartments are modulated by parameters specifying *maximum daily growth rates relative to the amount of sapwood area*. Additionally, tree leaf area, sapwood area and fine root biomass targets are constrained by leaf biomass allometric equations, which limits tissue growth to the replacement of aging tissues, unless there are changes in forest structure, i.e. competition is released or the target tree increases in diameter (see fig. \@ref(fig:allocationdiagram)). Since sapwood formation leads to tree diameter increases, and therefore to forest structural changes, maximum sapwood growth rate indirectly determine the rate of growth of leaves and fine roots at seasonal and annual scales, hence determining the whole-plant maximum growth rate. 

### Functional coordination of tissue growth

Two options are possible regarding the functional coordination between structural carbon of leaves and sapwood:
...
Further details and formulation of growth, senescence and functional coordination are given in chapter \@ref(growthsenescencemortality).
