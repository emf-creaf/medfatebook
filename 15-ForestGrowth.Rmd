...
The forest growth model allows simulating the variation of leaf area, sapwood area and fine root area via the following processes (see fig. \@ref(fig:allocationdiagram)):
 ...
 i. **Leaf/twig growth**: Whereas in the water balance models expanded leaf area corresponded to the portion of live leaf area that was unfolded according to the phenological status, in the growth model leaf area results from explicit simulation of growth. However, the leaf phenology submodel still controls the duration of phenophases corresponding budburst, leaf development and senescence (see \@ref(leafphenology)). Leaf area increase occurs during *leaf unfolding* period only, which spans the whole year in *progressive-evergreen* plants. In other phenology types (i.e. *oneflush-evergreen*, *winter-deciduous* and *winter-semideciduous*), leaf organogenesis is temporally separated from leaf unfolding: Leaf unfolding (i.e. expansion) occurs in spring only, and builds on preformed organs within buds, whose amount is controlled by the target leaf area and water stress during the *bud formation* period (occurring in autumn). Leaf area target limits the maximum amount of leaves preformed during organogenesis and this target is determined by plant size (i.e. tree diameter) and stand structure (i.e. competition for light) via allometric equations. Organogenesis during bud formation does not consume any carbon, but leaf unfolding does and storage carbon levels need to be at more than 10\% of their capacity to allow leaf unfolding. Moreover, leaf unfolding includes an additional carbon cost in *twig growth*, according to the biomass ratio between both.
