...
### Growth, senescence and allocation
...
2. Determine the current amount of live structural biomass (in leaves, sapwood and fine root compartments), storage volume (in leaves and sapwood) and storage capacity (see \@ref(estimationcarbonpools)). 
3. Calculate gross photosynthesis per individual ($A$), maintenance respiration costs for leaves ($R_{leaf}$), sapwood ($R_{sapwood}$) and fine roots ($R_{fineroot}$) (see \@ref(carbonbalancecomponents)).
