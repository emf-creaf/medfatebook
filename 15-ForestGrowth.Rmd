...
Growth phenology types are defined by combining leaf phenology types (i.e. evergreen, winter-deciduous or winter-semideciduous) with the degree of determinacy of growth, which describes whether growth in the current year occurs [@baumgarten_determinacy_2026]: (a) from elogating organs preformed the preceding year and contained within persistent buds (determined growth); (b) from continuous meristem activity forming new shoots (indetermined growth); or (b) from both (intermediate growth). The following combinations of leaf phenology and growth determinacy are distinguished, which are illustrated in \@ref(fig:phenology)):

  + *Indeterminate evergreen*: Indetermined evergreen plants are assumed to shed old leaves at the same time as new leaves appear. Leaf senescence and leaf formation can occur continuously throughout the year, and leaf growth occurs without bud phase.
  + *Determinate evergreen*: Determinate evergreen plants are assumed to form persistent buds before winter and concentrate budburst, leaf elongation and leaf senescence during a similar period in spring. The amount of leaf area to be flushed in spring is decided during the persistent bud formation period (i.e. in autumn), when leaf organogenesis is assumed to occur.
  + *Intermediate evergreen*: Evergreen plants with intermediate growth determinacy have a mixed growth strategy. Like determinate plants, persistent buds are formed in autumn and a first set of leaves is flushed in spring. Additionally, the plant can continue forming new leaves after these initial ones have finished elongation, in the same way as a indeterminate evergreen plants, until there is a decrease in photoperiod. From that moment on, persistent buds are formed for the next year. 
  + *Determined winter-(semi)deciduous*: In winter-deciduous plants, leaf shedding and leaf bud formation both occur in autumn, and buds remain under dormancy until spring, when budburst and elongation occurs. Therefore, the plant has a non-zero leaf area during the period limited by leaf elongation and leaf shedding events. After the elongation of preformed leaves, leaf organogenesis and elongation can continue during the growing season, until the decrease in photoperiod surpasses a threshold, as in polycyclic plants. Like in one-flush evergreen plants, the amount of leaf area to be flushed is decided during the bud formation period for the growth model, which in this case is set to occur between the decrease of photoperiod and the start of dormancy. 
  + *Indetermined winter semi-deciduous*: 
...
The forest growth model allows simulating the variation of leaf area, sapwood area and fine root area via the following processes (see fig. \@ref(fig:allocationdiagram)):
 ...
 i. **Leaf/twig growth**: Whereas in the water balance models expanded leaf area corresponded to the portion of live leaf area that was unfolded according to the phenological status, in the growth model leaf area changes result from explicit simulation of growth. However, the leaf phenology submodel still controls the duration of phenophases corresponding to leaf organogenesis, leaf elongation and leaf senescence (see \@ref(leafphenology)). Leaf area increase occurs during *leaf elongation* periods only, which spans the whole year in *evergreen-progressive* plants. In other phenology types (i.e. *evergreen-oneflush*, *evergreen-polycyclic*, *winter-deciduous* and *winter-semideciduous*), leaf organogenesis is temporally separated from leaf elongation: In *evergreen-oneflush* leaf elongation occurs in spring only, and builds on preformed organs within buds, whose amount is controlled by the target leaf area and water stress during the persistent bud formation period (occurring in autumn), whereas in *evergreen-polycyclic*, *winter-deciduous* and *winter-semideciduous* additional leaves can be formed after the elongation of preformed leaves. Leaf area target limits the maximum amount of leaves formed during organogenesis and this target is determined by plant size (i.e. tree diameter) and stand structure (i.e. competition for light) via allometric equations. Organogenesis during persistent bud formation does not consume any carbon, but leaf elongation does consume carbon and storage carbon levels need to be at more than 10\% of their capacity to allow leaf elongation. Moreover, leaf elongation includes an additional carbon cost in *twig growth*, according to the biomass ratio between both.
