...
The calculations can be illustrated with function `light_directExtinctionCoefficient()`:

```{r}
solarElevation <- 40 # in degrees
leafAngle <- 60 # in degrees

kb <- light_directExtinctionCoefficient(leafAngle*(pi/180), solarElevation*(pi/180))
kb
```
...
We will also define the coefficients of diffuse extinction, leaf absorbance and leaf reflection:
```{r}
kd_PAR = 0.5
kd_SWR = kd_PAR/1.35
alpha_PAR = 0.9
