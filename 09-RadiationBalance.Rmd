...
LAIlayermist = matrix(0,nlayer,1)
```
...
Ibfpar <- light_layerDirectIrradianceFraction(LAIlayerlive,LAIlayerdead,LAIlayermax, LAIlayermist,
                                             kb, clumping,
                                             alpha_PAR, gamma_PAR,
                                             kb_mistletoe = 0.9, CI_mistletoe = 0.75, alpha_mistletoe = 0.7, gamma_mistletoe = 0.14)
Ibfswr <- light_layerDirectIrradianceFraction(LAIlayerlive,LAIlayerdead,LAIlayermax, LAIlayermist,
                                             kb, clumping,
                                             alpha_SWR, gamma_SWR,
                                             kb_mistletoe = 0.9, CI_mistletoe = 0.75, alpha_mistletoe = 0.7, gamma_mistletoe = 0.14)
fsunlit = light_layerSunlitFraction(LAIlayerlive, LAIlayerdead, LAIlayermist, kb, clumping,
                                    kb_mistletoe = 0.9, CI_mistletoe = 0.75)
...
abs_PAR <- light_cohortSunlitShadeAbsorbedRadiation(PAR_direct, PAR_diffuse,
                                                   LAIlayerlive, LAIlayerdead, LAIlayermax, LAIlayermist, 
                                                   kb, KDIFF, clumping, ZF, 
                                                   alpha_PAR, gamma_PAR,
                                                   kb_mistletoe = 0.9, K_mistletoe = KDIFF[1,], CI_mistletoe = 0.75, alpha_mistletoe = 0.7, gamma_mistletoe = 0.14)
