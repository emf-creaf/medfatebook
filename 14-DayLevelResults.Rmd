...
\end{equation}
An the same for water extraction $Ex_{i,s,t}$ for each soil layer $s$:
\begin{equation}
Ex_{i,s} = \sum_{t=1}^{n_t} {Ex_{i,s,t}}
\end{equation}
$Ex_{i,s}$ are substracted from the water content of the corresponding soil layer, closing the soil water balance of the day. 
